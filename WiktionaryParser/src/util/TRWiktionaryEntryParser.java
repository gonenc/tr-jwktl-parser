...
import components.TRPronounciationHandler;
...
public class TRWiktionaryEntryParser extends WiktionaryEntryParser
{
	...
	public TRWiktionaryEntryParser(ILanguage language, String redirectName)
	{
		...
		register(new TRRelationHandler(RelationType.SYNONYM, "Eş Anlamlılar", "Eş anlamlılar"));
		register(new TRRelationHandler(RelationType.ANTONYM, "Karşıt Anlamlılar", "Karşıt anlamlılar"));
		register(new TRRelationHandler(RelationType.HYPERNYM, "Üst Kavramlar", "Üst kavramlar"));
		register(new TRRelationHandler(RelationType.HYPONYM, "Alt Kavramlar", "Alt kavramlar"));
		register(new TRRelationHandler(RelationType.COORDINATE_TERM, "Yan Kavramlar", "Yan kavramlar"));
		register(new TRRelationHandler(RelationType.CHARACTERISTIC_WORD_COMBINATION, "Sözcük Birliktelikleri","Sözcük birliktelikleri"));
		register(new TRRelationHandler(RelationType.CHARACTERISTIC_WORD_COMBINATION, "Kelime birliktelikleri", "Kelime Birliktelikleri"));
		...
		register(new TRPronounciationHandler());
